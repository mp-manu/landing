...
insert  into `events`(`id`,`title`,`description`,`date_from`,`date_to`,`category_id`,`photo`,`status`,`created_at`,`created_by`,`updated_at`,`updated_by`) values 
(1,'adwadwad','<p>dawdawdawdawdwa</p>','2019-12-01 00:00:00','2019-12-11 00:00:00',NULL,'adwadwad.png',1,1576760782,1,1576760782,1);
...
(1,0,0,'Home','Home','/','ALL',1,NULL,2,NULL,'','no','no','','yes',NULL,NULL),
(2,0,0,'About','About','#','ALL',1,NULL,3,NULL,'','no','no','','yes',NULL,NULL),
(3,2,0,'NEW MARKET','NEW MARKET','/about/new-markets','ALL',1,NULL,0,NULL,'','no','no','','yes',NULL,NULL),
(4,2,0,'Team','Team','/about/team','ALL',1,NULL,6,NULL,'','no','no','','yes',NULL,NULL),
(5,0,0,'Publications','Publications','/publication/list','ALL',1,NULL,4,NULL,'','no','no','','yes',NULL,NULL),
(6,0,0,'Events','Events','/events/list','ALL',1,NULL,9,NULL,'','no','no','','yes',NULL,NULL),
(7,0,0,'News','News','/','ALL',1,NULL,10,NULL,'','no','no','','yes',NULL,NULL),
(8,0,0,'Contact Us','Contact Us','/','ALL',1,NULL,11,NULL,'','no','no','','yes',NULL,NULL);
...
insert  into `team`(`id`,`university`,`person`,`responsibility`,`about`,`photo`,`status`,`created_at`,`created_by`,`updated_at`,`updated_by`,`project_id`) values 
(1,'Dublin City University (Institute for International Conflict Resolution and Reconstruction)','Abel Polese','Project Coordinato','Abel Polese is a researcher, development worker, trainer and author of “the Scopus diaries and the (il)logics of academic survival','abel-polese.jpg',1,1576748131,1,1576748131,1,1),
(2,'Dublin City University (Institute for International Conflict Resolution and Reconstruction)','Donnacha Ó Beacháin ','','Donnacha Ó Beacháin is Director of Research at the School of Law and Government, Dublin City University (DCU). During 2011-12 he was a recipient of an 18 month major research grant from the IRCHSS/Department of Foreign Affairs Conflict Resolution Unit to lead a research team to examine the role of the OSCE and EU in the post-Soviet “frozen conflicts”. The project was designed to assist the Irish Government as it chaired the OSCE in 2012 and hosted the EU Presidency in 2013. In January 2012 Dr Ó Beacháin also received an additional commission from the IRCHSS/Department of Foreign Affairs to conduct field research in Abkhazia and Transnistria. Dr Ó Beacháin held a three year (2008-11) Marie Curie Fellowship awarded by the European Commission to conduct research on the colour revolution phenomenon. Previously, between 2000 and 2005, Dr. Ó Beacháin held visiting fellowships in Georgia, Uzbekistan and Kazakhstan.\r\n\r\nRecent and forthcoming books include The Colour Revolutions in the Former Soviet Republics (with Abel Polese, Routledge, 2010), Destiny of the Soldiers: Fianna Fáil, Irish Republicanism and the IRA 1926-1973, (Gill and Macmillan, 2010), Life in Post-Communist Eastern Europe after EU Membership (with Vera Sheridan and Sabina Stan, Routledge, 2012), Political Communication in Ireland (with Mark O’Brien, Liverpool University Press 2014) and From Partition to Brexit (Manchester University Press, forthcoming).','',1,1576749219,1,1576749219,1,1),
(3,'Dublin City University (Institute for International Conflict Resolution and Reconstruction)','Gian Marco Moisé','','PhD student of the School of Law and Government at the Dublin City University, Gian Marco has a first master degree in international relations on the Former Soviet Union, and a second one on human rights in the Western Balkans. As a collaborator of the Italian online newspaper East Journal, he regularly writes political and social analyses of the most recent developments in Eastern Europe and Central Asia. After short experiences in journalism, education and NGOs, he seized the opportunity to pursue a doctoral degree on informality in the framework of SHADOW.','gian-marco-moise.jpg',1,1576749229,1,1576749229,1,1),
(4,'University of Lund','Rustam Urinboyev ','Contact Person','Rustam Urinboyev is a senior research fellow at the Department of Sociology of Law, Lund University and a Marie-Skłodowska Curie Fellow at the Aleksanteri Institute, University of Helsinki. Rustam received his PhD in sociology of law for a thesis entitled: “Living Law and Political Stability in Post-Soviet Central Asia” (2013). His thesis explored the interconnections between informal economy, community-based traditional governance institutions and political stability.','rustam-urinboyev.jpg',1,1576748786,1,1576748786,1,1),
(5,'University of Lund','Diana T. Kudaibergenova','','','',1,1576748814,1,1576748814,1,1);
